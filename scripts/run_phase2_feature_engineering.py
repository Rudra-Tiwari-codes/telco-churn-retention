...
from src.features.store import FeatureStore, FeatureMetadata
...
def main() -> None:
    ...
    console.print(f"[green]Registered feature set: {metadata.feature_set_name} v{metadata.version}[/green]")
